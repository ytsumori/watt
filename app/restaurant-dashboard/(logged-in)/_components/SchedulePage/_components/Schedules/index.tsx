        ...
        [last, ...dayOfWeeks].map((dayOfWeek, idx) => {
          ...
          return (
            <Box key={dayOfWeek} m={2}>
              ...
              <UnorderedList>
                {sortOpeningHours<(typeof openingHour.regularOpeningHours)[number]>(
              ...
              {openingHour.holidayOpeningHours[0] && (
                <Box borderColor="gray" borderWidth={1} borderRadius={5} p={3}>
                  ...
                  <UnorderedList>
                    <>
                      <UnorderedList>
                        {sortOpeningHours<(typeof openingHour.holidayOpeningHours)[number]>(
                          openingHour.holidayOpeningHours
                        ).map((holidayHour) => {
                          return (
