...
import { visitRestaurant } from "../../meals/[mealId]/_actions/visit-restaurant";
...
export function RestaurantPage({ restaurant, preorderId, userId }: Props) {
  ...
  const handleVisitingConfirm = async () => {
    ...
    visitRestaurant({ mealId: firstPersonMeal.id, userId })
      .then((order) => {
                  ...
                  <>
                    ...
                    <Select
                      ...
                      onChange={(e) => {
                        ...
                        setPeopleCount(e.target.value as "1" | "2");
                      }}
                    >
                    ...
                    {peopleCount === "1" ? (
                      <>
                        ...
                        <Divider borderColor="black" my={6} />
                        <VisitingSection isLoading={isVisitRequesting} onClick={handleVisitingConfirm} />
                      </>
                    ) : (
                      <>
                        <Divider borderColor="blackAlpha.400" />
                        ...
                        {secondPersonMeal && (
                          <>
                            ...
                            />
                            <Divider borderColor="black" my={6} />
                            <PriceSection firstPersonMeal={firstPersonMeal} secondPersonMeal={secondPersonMeal} />
                            <Divider borderColor="black" my={6} />
                            <VisitingSection isLoading={isVisitRequesting} onClick={handleVisitingConfirm} />
                          </>
                        )}
