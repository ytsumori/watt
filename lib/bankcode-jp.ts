...
export async function searchBanks({ text }: { text: string }) {
  ...
  return response.json() as Promise<
    Partial<{ banks: BankcodeSearchResult[] } & BankcodeErrorMessage>
  >;
}
...
export async function getBank({ bankCode }: { bankCode: string }) {
  ...
  return response.json() as Promise<
    Partial<BankcodeSearchResult & BankcodeErrorMessage>
  >;
}
...
export async function searchBranches({ bankCode }: { bankCode: string }) {
  ...
  return response.json() as Promise<
    Partial<{ branches: BankcodeSearchResult[] } & BankcodeErrorMessage>
  >;
}
...
export async function getBranch({
  ...
  return response.json() as Promise<
    Partial<{ branch: BankcodeSearchResult } & BankcodeErrorMessage>
  >;
}
